...
<template>
  <section class="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary via-emerald-600 to-green-700">
    ...
    >
      ...
      <p class="text-lg md:text-xl lg:text-2xl text-white/90 mb-6 md:mb-8 max-w-2xl mx-auto px-4">
        Efficient ticket tracking and management system for modern teams
      </p>
      <button
        @click="handleGetStarted"
        :disabled="isLoading"
        class="px-6 md:px-8 py-3 md:py-4 bg-white text-primary rounded-lg font-semibold text-base md:text-lg hover:bg-gray-100 transition-all shadow-xl hover:shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed"
      >
