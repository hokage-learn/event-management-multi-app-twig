...
<template>
  <section id="features" class="py-16 md:py-20 lg:py-24 bg-white relative">
    <div 
      class="max-w-container mx-auto px-4"
    ...
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
          ...
          <h3 class="text-xl font-bold text-gray-900 mb-3">Create & Edit</h3>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
          ...
          <h3 class="text-xl font-bold text-gray-900 mb-3">Organize & Track</h3>
          <p class="text-gray-600 leading-relaxed">
